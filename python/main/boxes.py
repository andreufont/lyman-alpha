...
class SimulationBox(Box):
    ...
    def __init__(self, snap_num, snap_dir, grid_samps, spectrum_pixel_width, axis=1, spectrograph_FWHM='default', reload_snapshot=True, spectra_savefile_root='gridded_spectra', spectra_savedir=None):
        self._n_samp = {}
        ...
        if spectrograph_FWHM == 'default':
            self.spectra_instance = my_spectra.GriddedSpectra(self._snap_num,
